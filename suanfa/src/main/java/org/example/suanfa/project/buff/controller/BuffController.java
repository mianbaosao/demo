...
public class BuffController {
    ...
    public ResponseEntity<BuffVO> upgradeBuff(@PathVariable Long userId, @PathVariable Integer buffId) {
        return ResponseEntity.ok(buffService.upgradeBuff(userId, buffId));
    }

    @PostMapping("/request")
    public BuffVO resques(@RequestBody BuffParam param) {
        return buffService.testVO(param);
    }
